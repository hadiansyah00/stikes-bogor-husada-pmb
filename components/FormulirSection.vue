  ...
  <section class="py-16 bg-orange-50">
    <div class="container max-w-xl px-4 mx-auto">
      <h2 class="mb-8 text-3xl font-bold text-center text-gray-800">
        Formulir Pendaftaran Beasiswa SNBT
      </h2>

      <form
        @submit.prevent="handleSubmit"
        class="p-8 space-y-6 bg-gray-100 border border-orange-200 shadow-md rounded-xl"
      >
        <!-- Nama Lengkap -->
        <div>
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-2 py-1 text-sm text-orange-600 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400"
            required
          >
        ...
        <!-- Alert Messages -->
        <div v-if="successMessage" class="p-3 text-green-700 bg-green-100 rounded">
          {{ successMessage }}
        </div>
